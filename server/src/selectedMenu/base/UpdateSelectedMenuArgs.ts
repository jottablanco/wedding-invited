...
@ArgsType()
class UpdateSelectedMenuArgs {
  @Field(() => SelectedMenuWhereUniqueInput, { nullable: false })
  where!: SelectedMenuWhereUniqueInput;
  @Field(() => SelectedMenuUpdateInput, { nullable: false })
  data!: SelectedMenuUpdateInput;
}

export { UpdateSelectedMenuArgs };
