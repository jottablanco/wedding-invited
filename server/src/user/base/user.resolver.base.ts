...
import { SelectedMenu } from "../../selectedMenu/base/SelectedMenu";
...
export class UserResolverBase {
  ...
  async createUser(
    ...
    return await this.service.create({
      ...
      data: {
        ...
        selectedMenu: args.data.selectedMenu
          ? {
              connect: args.data.selectedMenu,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => SelectedMenu, { nullable: true })
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "read",
    possession: "any",
  ...
  async selectedMenu(
    ...
    const result = await this.service.getSelectedMenu(parent.id);
